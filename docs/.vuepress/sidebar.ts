...
export default defineSidebarConfig({
  ...
  "/linux/": [
    ...
    // HOME服务器日志
    {
      ...
      icon: "emoji",
      children: [
        { text: "服务器安装软件日志", link: "home.centos7-install.log.md", },
    ...
    // Java核心
    {
      ...
      children: [
        ...
        { text: "泛型", link: "everytype.md" },
        {
          ...
          prefix: "jvm/",
          children: [
            { text: "01.类的编译、加载及运行.md", link: "01.类的编译、加载及运行.md" },
            { text: "02.内存结构.md", link: "02.内存结构.md" },
            { text: "03.java中的GC.md", link: "03.java中的GC.md" },
            { text: "04.字节码文件.md", link: "04.字节码文件.md" },
            { text: "05.虚拟机中的高效并发.md", link: "05.虚拟机中的高效并发.md" },
            { text: "面试题.md", link: "面试题.md" },
          ],
        },
        {
          text: "JVM02",
          ...
          prefix: "jvm02/",
          children: [
            { text: "00-jvm作业.md", link: "00-jvm作业.md" },
            { text: "01-初识jvm.md", link: "01-初识jvm.md" },
            { text: "02-jvm运行机制.md", link: "02-jvm运行机制.md" },
            { text: "03-常用jvm配置参数.md", link: "03-常用jvm配置参数.md" },
            { text: "04-GC算法和种类.md", link: "04-GC算法和种类.md" },
            { text: "05-GC参数.md", link: "05-GC参数.md" },
            { text: "06-类加载器.md", link: "06-类加载器.md" },
            { text: "07-性能监控工具.md", link: "07-性能监控工具.md" },
            { text: "08-java堆分析.md", link: "08-java堆分析.md" },
            { text: "jvm编译和运行过程.md", link: "jvm编译和运行过程.md" },
          ],
        },
